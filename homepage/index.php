    ...
    <div class="container">
      <div class="section-head center">
        <h1 class="section-title">
          ليه <span>إحنا؟</span> وليه منصتنا مختلفة
        </h1>
      ...
      <div class="cards">
        ...
        <article class="carde">
          <div class="card-body">
            <div class="card-top">
              <div class="card-img">
                <img src="./img/استشارة نفسية فردية .png" alt=" استشارة نفسية فردية">
                <div>
        ...
        <article class="carde">
          <div class="card-body">
            <div class="card-top">
              <div class="card-img">
                <img src="./img/بارمج علاجية متخصصة.png" alt=" برامج علاجية متخصصة">
                <div>
        ...
        <article class="carde">
          <div class="card-body">
            <div class="card-top">
              <div class="card-img">
                <img src="./img/اختبارات نفسية.png" alt="اختبارات نفسية">
                <div>
      ...
      <div class="stories-grid">
        ...
        <div class="card green">
          <div class="quote-box">
            ...
            <p> "كنت أعاني من قلق مستمر أثر على حياتي العملية والاجتماعية. بعد 8 جلسات مع د. سارة، تعلمت كيف أتعامل مع
              القلق وأصبحت أكثر ثقة بنفسي."</p>
          </div>
          <div class="footer">
            <div class="details">
        ...
        <div class="card pink">
          <div class="quote-box">
            <div class="quote-icon">“</div>
            <p>"مرّيت بفترة صعبة بعد فقدان وظيفتي. الأخصائي ساعدني أفهم مشاعري وأعيد بناء ثقتي. الآن أنا في وظيفة أفضل
              وحياتي تحسنت كثير."</p>
          </div>
          <div class="footer">
            <div class="details">
        ...
        <div class="card blue">
          <div class="quote-box">
            <div class="quote-icon">“</div>
            <p>"عانيت من الأرق لسنوات. من خلال الجلسات، تعلمت تقنيات الاسترخاء وغيّرت عاداتي. الآن أنام بشكل طبيعي وأشعر
              بطاقة أكبر." </p>
          </div>
          <div class="footer">
            <div class="details">
    ...
    <div class="footer-container">
      ...
      <div class="footer-col">
        ...
        <div class="footer-social">
          <a href="https://www.facebook.com/share/18ZC3jbTpz/?mibextid=wwXIfr" class="social-icon"><i
              class="fab fa-facebook-f"></i></a>
          <a href="https://wa.me/972598584750" class="social-icon"> <i class="fa-brands fa-whatsapp"></i></a>
          <a href="https://www.instagram.com/zat_psychological_counseling?igsh=MXRqYzBmdmtoeG40ZA=="
