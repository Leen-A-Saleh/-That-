...
-- DROP TABLES
-- ============================================================
DROP TABLE IF EXISTS therapist_reviews;
...
CREATE TABLE session_notes (
    ...
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (note_id),
    CONSTRAINT fk_note_session FOREIGN KEY (session_id) REFERENCES sessions (session_id) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
-- ============================================================
-- 8. MESSAGES
-- ============================================================
...
CREATE TABLE assessment_results (
    ...
    status VARCHAR(15) NOT NULL DEFAULT 'PENDING' CHECK (status IN ('PENDING', 'REVIEWED', 'DISCUSSED')),
    reviewed_at DATETIME NULL,
...
CREATE TABLE therapist_reviews (
    ...
    CONSTRAINT fk_review_therapist FOREIGN KEY (therapist_id) REFERENCES therapists (therapist_id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_review_client FOREIGN KEY (client_id) REFERENCES clients (client_id) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
ADD status ENUM('ACTIVE','INACTIVE','PENDING') NOT NULL DEFAULT 'ACTIVE',
ADD color VARCHAR(7) NOT NULL DEFAULT '#4F46E5';
...
ADD title_ar VARCHAR(200) NULL AFTER title,
ADD description_ar TEXT NULL AFTER description;
...
CREATE INDEX idx_reviews_therapist ON therapist_reviews (therapist_id);