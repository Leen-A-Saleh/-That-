...
<header class="main-header">
  ...
  <div class="header-left">
    <?php if (isset($_SESSION['user_id'])): ?>
      ...
      <a href="/That-Copy/Auth/handlers/logout.php" class="nav-link">تسجيل الخروج</a>
    <?php else: ?>
      <a href="/That-Copy/Auth/login/index.php" class="nav-link active-login">تسجيل الدخول</a>
      <a href="/That-Copy/Auth/signup/index.php" class="nav-link active-login btn btn-primary">إنشاء حساب</a>
    <?php endif; ?>
  </div>
</header>
      ...
      <div class="cards">
        ...
        <article class="carde">
          <div class="card-body">
           ...
           <a href="/That-Copy/Auth/login/index.php" class="card-link">اعرف المزيد</a>
          </div>
        </article>
